...
def fit_DMPDE(scan_data: dict, return_metadata: bool, verbose=False):
    """
    ...
    def unique_residual(x, y_true, params):
        ...
        Eon, Eoff, Din, Dout = unpack_params(params)
    ...
    x0 = pack_params(Eon, Eoff, Din, Dout)
    ...
    Eon_fit, Eoff_fit, Din_fit, Dout_fit = unpack_params(result.x)
