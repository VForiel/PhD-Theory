...
def fit_MPCE(scan_data: dict, return_metadata: bool, verbose=False):
    """
    ...
    # We aim to fit the complex parameters of Eon, Eoff and Cin, while P is known from the phase shifter settings during the scan.
    ...
    def unique_residual(x, y_true, params):
        ...
        Eon, Eoff, Cin = unpack_params(params)
    ...
    Eon_fit, Eoff_fit, Cin_fit= unpack_params(result.x)
    ...
    return model, Eon_fit, Eoff_fit, Cin_fit
